...
namespace TestEstante
{
    class Program
    {
        ...
        /// <summary>
        /// Ordena dos productos por codigo de barra
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <returns>0 si los codigos de barra son iguales, 1 si el codBarra del x es mayor, -1 si el codBarra del x es menor</returns>
